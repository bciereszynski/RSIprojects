...
@WebServiceClient(name = "ServerInfoService",
        targetNamespace = "http://ws.rsi.com/",
    ...
    extends Service
{
    ...
    private final static QName SERVERINFOSERVICE_QNAME = new QName("http://ws.rsi.com/", "ServerInfoService");
    ...
    public ServerInfo getServerInfoPort() {
        return super.getPort(new QName("http://ws.rsi.com/", "ServerInfoPort"), ServerInfo.class);
    }
    ...
    public ServerInfo getServerInfoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.rsi.com/", "ServerInfoPort"), ServerInfo.class, features);
    }
