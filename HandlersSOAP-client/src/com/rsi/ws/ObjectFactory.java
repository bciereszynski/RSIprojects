 ...
 * generated in the com.rsi.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetServerName_QNAME = new QName("http://ws.rsi.com/", "getServerName");
    private final static QName _GetServerNameResponse_QNAME = new QName("http://ws.rsi.com/", "getServerNameResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.rsi.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.rsi.com/", name = "getServerName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.rsi.com/", name = "getServerNameResponse")
